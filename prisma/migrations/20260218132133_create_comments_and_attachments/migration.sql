...
-- AddForeignKey
ALTER TABLE "comments" ADD CONSTRAINT "comments_@answer_id_fkey" FOREIGN KEY ("@answer_id") REFERENCES "answers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "attachments" ADD CONSTRAINT "attachments_@answer_id_fkey" FOREIGN KEY ("@answer_id") REFERENCES "answers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
